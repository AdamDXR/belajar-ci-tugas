...
- Panel Admin
  ...
  - Export data ke PDF (Tersedia di halaman Manajemen Produk)
- Sistem Autentikasi
  - Login pengguna
...
5. **Seeder data**
   ...
   ```
   *(Catatan: `UserSeeder` akan men-generate data admin dummy secara acak dengan password default: `1234567`)*
6. **Jalankan server**
   ```bash
   php spark serve
   ```
